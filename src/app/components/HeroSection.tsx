  ...
  return (
    <section id="inicio" className="relative w-full min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center lg:items-start justify-center min-h-screen px-6 md:px-16 lg:px-24 text-center lg:text-left text-white max-w-7xl mx-auto" data-sr-delay="0">
        <h1 className="font-['Inter'] text-4xl md:text-6xl lg:text-7xl leading-tight max-w-5xl lg:max-w-2xl">
          CONOCER NUESTROS DERECHOS NOS AYUDA A VIVIR CON <span className="italic">DIGNIDAD</span>
        </h1>
        <p className="mt-4 text-sm md:text-base opacity-80 max-w-xl lg:max-w-md font-['Inter']">
        ...
        <div className="flex flex-col sm:flex-row gap-3 mt-8 w-full sm:w-auto">
          <a href={whatsappHref} target="_blank" rel="noopener noreferrer" className="bg-white text-black rounded-full px-7 py-3 text-sm font-['Inter'] font-medium hover:bg-white/90 transition text-center">
            Agenda una Entrevista
          </a>
          <a href="#servicios" className="border border-white/50 rounded-full px-7 py-3 text-sm font-['Inter'] hover:bg-white/10 transition text-center">
            Conoce tus Derechos
          </a>
        </div>
